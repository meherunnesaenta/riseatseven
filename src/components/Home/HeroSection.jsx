...
import grobal from "../../assets/hero-logo/global.png";
import thedrum from "../../assets/hero-logo/thedrum.png";
import uksocial from "../../assets/hero-logo/uksocial.png";
import contentAwards from "../../assets/hero-logo/content-awards.png";
export default function HeroSection() {
    const headingRef = useRef(null);
    const bgImageRef = useRef(null);
    const headingImageRef = useRef(null);

    // Random images array - original images from HTML
    const randomImages = [
    ...
    useEffect(() => {
        // Select a random image ONCE for both background and heading
        const randomIndex = Math.floor(Math.random() * randomImages.length);
        const selectedImage = randomImages[randomIndex];

        // Set background image
        if (bgImageRef.current) {
            bgImageRef.current.src = selectedImage;
        }

        // Set heading image - SAME image as background
        if (headingImageRef.current) {
            headingImageRef.current.src = selectedImage;
        }
                        ...
                        <div className="hero-card">
                            <div className="hero-card-inner">
                                ...
                                <div className="hero-bg-image">
                                    <img ref={bgImageRef} alt="Background" />
                                </div>
                                ...
                                <div className="hero-content">
                                    <div className="hero-content-inner">
                                        ...
                                        <div className="hero-awards">
                                            <div className="hero-awards-badge">
                                                #1 Most recommended content marketing agency
                                            </div>
                                            <div className="hero-awards-icons">
                                                <svg viewBox="0 0 28 38" fill="none" xmlns="http://www.w3.org/2000/svg" className="hero-award-icon">
                                                ...
                                                <div className="hero-award-logo hidden-lg">
                                                    <img
src={contentAwards}                                                      alt="UK Content Awards"
                                                    />
                                                </div>
                                        ...
                                        <h1 ref={headingRef} className="hero-heading">
                                            <div className="hero-heading-line">
                                                <div className="hero-heading-word">
                                                    <AnimatedWord text="We" />
                                                </div>
                                                <div className="hero-heading-word">
                                                    <AnimatedWord text="Create" />
                                                </div>
                                            </div>
                                            <div className="hero-heading-line">
                                                <div className="hero-heading-word">
                                                    <AnimatedWord text="Category" />
                                                </div>
                                                <div className="hero-heading-image">
                                                    <img ref={headingImageRef} alt="Category" />
                                                </div>
                                                <div className="hero-heading-word">
                                                    <AnimatedWord text="Leaders" />
                                                </div>
                                            </div>
                                        </h1>
                                        ...
                                        {/* <div className="hero-platforms">
                                            <div className="hero-platform-logo">
                                                <img
                                                    src="https://rise-atseven.transforms.svdcdn.com/production/images/Placeholder-logos/gogle.png?w=400&q=80&fm=webp&fit=crop&dm=1750847622&s=a7382d4409915b1abb45c9bb1a46ecb5"
                                                    alt="Google"
                                                />
                                            </div>
                                            <div className="hero-platform-logo">
                                                <img
                                                    src="https://rise-atseven.transforms.svdcdn.com/production/images/Placeholder-logos/chat-gpt.png?w=400&q=80&fm=webp&fit=crop&dm=1750847621&s=6b6ab14958d6b993c66099365de714a9"
                                                    alt="ChatGPT"
                                                />
                                            </div>
                                            <div className="hero-platform-logo">
                                                <img
                                                    src="https://rise-atseven.transforms.svdcdn.com/production/images/Logos/Social/White/gemini.png?w=400&q=80&fm=webp&fit=crop&dm=1750847619&s=d95fa8ba08c60d6d2ef595327d306f79"
                                                    alt="Gemini"
                                                />
                                            </div>
                                            <div className="hero-platform-logo">
                                                <img
                                                    src="https://rise-atseven.transforms.svdcdn.com/production/images/Placeholder-logos/tiktok.png?w=400&q=80&fm=webp&fit=crop&dm=1750847623&s=f086fb6557612f99edef10aa79347c0b"
                                                    alt="TikTok"
                                                />
                                            </div>
                                            <div className="hero-platform-logo">
                                                <img
                                                    src="https://rise-atseven.transforms.svdcdn.com/production/images/Placeholder-logos/youtube.png?w=400&q=80&fm=webp&fit=crop&dm=1750847623&s=c70bddea4b620693075bdd9e26e6abbc"
                                                    alt="YouTube"
                                                />
                                            </div>
                                            <div className="hero-platform-logo">
                                                <img
                                                    src="https://rise-atseven.transforms.svdcdn.com/production/images/Logos/Social/White/pinterest.png?w=400&q=80&fm=webp&fit=crop&dm=1750847620&s=690b1cfec72e348875ac88b154038727"
                                                    alt="Pinterest"
                                                />
                                            </div>
                                            <div className="hero-platform-logo">
                                                <img
                                                    src="https://rise-atseven.transforms.svdcdn.com/production/images/Logos/Social/White/giphy.png?w=400&q=80&fm=webp&fit=crop&dm=1750847619&s=8e9f230dcd3f43c84fd153d7446f3404"
                                                    alt="GIPHY"
                                                />
                                            </div>
                                            <div className="hero-platform-logo">
                                                <img
                                                    src="https://rise-atseven.transforms.svdcdn.com/production/images/Logos/Social/White/reddit.png?w=400&q=80&fm=webp&fit=crop&dm=1750847620&s=d811bdc0b0ffd3534694e19e0b32ca2e"
                                                    alt="Reddit"
                                                />
                                            </div>
                                            <div className="hero-platform-logo">
                                                <img
                                                    src="https://rise-atseven.transforms.svdcdn.com/production/images/Logos/Social/White/amazon.png?w=400&q=80&fm=webp&fit=crop&dm=1750847619&s=b89cbede6552cbbce6327b02957d8fbb"
                                                    alt="Amazon"
                                                />
                                            </div>
                                        </div> */}
